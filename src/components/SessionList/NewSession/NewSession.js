            ...
            <form>
              ...
              <Input
                ...
                changed={e => {
                  ...
                  newValue > 0 && this.setState({ minPlayers: newValue });
                  newValue > parseInt(maxPlayers) &&
              ...
              <Input
                ...
                value={maxPlayers}
                changed={e =>
					parseInt(e.target.value) >= parseInt(minPlayers) && this.setState({ maxPlayers: e.target.value })
                }
                type="number"
                style={{ textAlign: "center", marginTop: "0" }}
                InputLabelProps={{
